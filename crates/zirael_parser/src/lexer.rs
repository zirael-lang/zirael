...
impl Display for TokenKind {
  fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
    use TokenKind::{
      ...
      BracketClose, BracketOpen, Char, Colon, Comma, Decrement, Divide, DivideEquals, Dollar, Dot,
      DoubleColon, Equals, EqualsEquals, FatArrow, Float, GreaterThan, GreaterThanOrEqual, Hash,
      Identifier, Increment, Integer, Keyword, LeftShift, LessThan, LessThanOrEqual, LogicalAnd,
      LogicalNot, LogicalOr, Minus, MinusEquals, Modulo, ModuloEquals, Multiply, MultiplyEquals,
      NotEquals, ParenClose, ParenOpen, Plus, PlusEquals, Power, Question, RightShift, Semicolon,
      String, Underscore,
    };
